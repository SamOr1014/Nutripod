...
export async function seed(knex: Knex) {
	...
	await knex(userWeightTableName)
		.insert([
			{
				weight: 50.4,
				date: "2022-09-01",
	...
	await knex(dietitianReportTableName)
		.insert([
			{
				date: "2022-09-17",
	...
	await knex(usersBloodPressureTableName)
		.insert([
			{
				sys_bp: 100,
				dia_bp: 110,
	...
	await knex(usersBloodGlucoseTableName)
		.insert([
			{
				bg_measurement: 100,
				date: "2022-09-13",
